    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                // Convert to LocalTime
                    ...
                    if(Licence.equals("") || (sectorcode.equals(""))){
                        ...
                        if(sector == null){
                            Toast.makeText(park_activity.this, "This sector doesn't exist.", Toast.LENGTH_SHORT).show();
                        }else{
                            if(sector.getAvailable_spots() == 0){
                                Toast.makeText(park_activity.this, "No parking spots available. Change sector.", Toast.LENGTH_SHORT).show();
                            }else{
                                double costToPark = Double.parseDouble(cost.getText().toString().replace("€", "").trim());
                                ...
                                Intent resultIntent = new Intent(park_activity.this, MainActivity.class);
        ...
        findViewById(R.id.LogoutButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(park_activity.this, LoginActivity.class);
